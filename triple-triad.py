...
if args.action == 'abolish':
    idx, reason = s.find_abolish(seed_data, args.start, args.rules, args.carry, args.target) 
elif args.action == 'spread':
    idx, reason = s.find_spread(seed_data, args.start, args.rules, args.carry, args.target)
...
if reason is not None:
    ...
    steps = s.compress_list(s.calculate_steps(seed_data, idx, args.start, args.rules, args.carry, args.queen_in_region, args.challenging_queen))
